# ESP32 Development Prototype

## Description

Embedded-systems workspace for ESP32 experiments, firmware sketches, and hardware integration notes.

## Quick Start

Inspect the source files and board configuration before flashing. Add the required board settings in the Arduino IDE or PlatformIO, then upload the firmware to a connected ESP32 board.
...
- ESP32 firmware experiments.
- hardware-oriented development notes.
- a base for sensor and device integrations.
